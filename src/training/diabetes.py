...
from src.common.preprocessing_util import replace_zeroes_with_nan
...
def train_diabetes_model():
    try:
        ...
        TARGET = settings.diabetes_target
        TEST_SIZE = settings.test_size
        RANDOM_STATE = settings.rs
        ...
        preprocess = ColumnTransformer(
            transformers=[
                (
                    ...
                    Pipeline(
                        steps=[
                            ("zero_to_nan",FunctionTransformer(replace_zeroes_with_nan, validate= False)),
        ...
        logging.info(f"Diabetes Training Completed.")

    except Exception as e:
        logging.exception(f"Error during diabetes model training")
        raise
